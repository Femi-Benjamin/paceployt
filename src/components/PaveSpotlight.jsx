      ...
      <div className="container" style={{ position: "relative", zIndex: 2 }}>
        <ScrollReveal variant="scale-up" delay={100}>
          <div
            ...
            style={{
              background:
                "linear-gradient(145deg, rgba(32, 16, 64, 0.95) 0%, rgba(14, 8, 28, 0.98) 100%)",
          ...
          >
            <div className="grid-2" style={{ alignItems: "center" }}>
              ...
              <div>
                ...
                >
                  Engineered from the ground up by{" "}
                  <strong style={{ color: "#ffffff" }}>Paceployt Tech</strong>,
                  PAVE is a premier next-generation digital wealth & financial
                  technology ecosystem designed to help individuals and
                  enterprises build wealth, automate savings, and process secure
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Automated digital savings & returns
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Encrypted transaction infrastructure
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      inset: 0,
                      background:
                        "linear-gradient(to top, rgba(9,5,20,0.92) 0%, transparent 60%)",
                    }}
                  ></div>
