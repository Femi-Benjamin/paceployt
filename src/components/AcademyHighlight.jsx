  ...
  const tracks = [
    ...
    },
    {
      ...
      features: [
        ...
        "Portfolio critique & presentation",
      ],
    },
  ];
  ...
  return (
    <section id="academy" style={{ padding: "100px 0", position: "relative" }}>
      ...
      <div className="container" style={{ position: "relative", zIndex: 2 }}>
        ...
        >
          <div
            className="badge-pill badge-academy"
          ...
          >
            ...
            <span style={{ color: "#a78bfa" }}>
              Tech Leaders & Software Engineers
            </span>
          </h2>
          <p style={{ color: "var(--text-muted)", fontSize: "1.1rem" }}>
            We don't just build digital solutions—we equip aspiring developers
            and designers with hands-on, practical expertise to build thriving
            tech careers.
          </p>
        </div>
                ...
                <div>
                  ...
                  >
                    {track.features.map((f, i) => (
                      ...
                      >
                        <CheckCircle size={14} style={{ color: track.color }} />{" "}
                        {f}
                      </div>
                    ))}
                  </div>
        ...
        <div
          ...
          style={{
            ...
            textAlign: "center",
            background:
              "linear-gradient(135deg, rgba(139, 92, 246, 0.15) 0%, rgba(7, 11, 20, 0.9) 100%)",
        ...
        >
          ...
          >
            ...
            <h3 style={{ fontSize: "1.6rem", fontWeight: 800 }}>
              Ready to Start Your Tech Journey with Paceployt Academy?
            </h3>
          </div>
          <p
            style={{
          ...
          >
            Get mentorship from active software engineers, build real
            client-grade projects, and join over 1,000+ empowered graduates
            setting the pace across the globe.
          </p>
          <button
            onClick={onOpenContact}
