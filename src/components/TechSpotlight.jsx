...
export default function TechSpotlight({ onOpenContact }) {
  ...
  return (
    <section
      ...
      style={{ background: "rgba(9, 5, 20, 0.9)", position: "relative" }}
    >
          ...
          <div className="glass-card-elevated">
            <div className="grid-2" style={{ alignItems: "center" }}>
              <div>
                ...
                >
                  Paceployt Tech{" "}
                  <span className="gradient-text-purple">Digital Agency</span>
                </h2>
                <p
                  style={{
                ...
                >
                  Whether you need a bespoke website, a complex SaaS platform,
                  or a custom mobile application, Paceployt's engineering team
                  brings your vision to life with precision and speed.
                </p>
              ...
              <div style={{ position: "relative" }}>
                ...
                >
                  <img
                    src="/images/tech_agency_studio.jpg"
                    alt="Paceployt Tech Digital Agency Studio"
                    style={{
                      width: "100%",
