...
export default function TestimonialsSection() {
  ...
  const reviews = [
    {
      ...
      quote: 'Paceployt delivered a clear, research-backed IT transformation roadmap that elevated our product speed and team efficiency beyond expectations.',
      stars: 5,
    ...
    },
    {
      ...
      quote: 'Paceployt transformed our outdated legacy systems into a sleek, high-performing web application. Their tech team delivered ahead of schedule with flawless code.',
      stars: 5,
    ...
    },
    {
      ...
      quote: 'Paceployt combines deep business strategy with cutting-edge tech execution. Their consulting and agritech logistics insight helped us scale across three regional hubs.',
      stars: 5,
    ...
    },
    {
      ...
      quote: 'Building our financial wealth platform with Paceployt was seamless. Their engineering standards, API architecture, and UI execution are truly top tier.',
      stars: 5,
  ...
  return (
    <section id="testimonials" className="section-padding" style={{ background: 'rgba(7, 4, 18, 0.95)', position: 'relative', overflow: 'hidden' }}>
      
      {/* Background Radial Glow & Wireframe Grid Graphic */}
      <div className="glow-spot-purple" style={{ top: '15%', left: '50%', transform: 'translateX(-50%)' }}></div>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      height: '40px',
                      borderRadius: '50%',
                      background: isCenter ? 'rgba(91, 26, 234, 0.35)' : 'rgba(255, 255, 255, 0.05)',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      color: isCenter ? '#c084fc' : 'var(--text-subtle)',
                      boxShadow: isCenter ? '0 0 20px rgba(168, 85, 247, 0.4)' : 'none'
                    }}
                  >
                    <Quote size={18} />
                  </div>
                  ...
                  <div>
                    {/* Gold Stars */}
                    <div style={{ display: 'flex', gap: '0.3rem', color: '#fbbf24', marginBottom: '1rem' }}>
                      {[...Array(rev.stars)].map((_, i) => (
                        <Star key={i} size={15} fill="#fbbf24" style={{ filter: 'drop-shadow(0 0 6px rgba(251, 191, 36, 0.5))' }} />
                      ))}
                    </div>
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem' }}>
                      ...
                      <div>
                        <div style={{ fontWeight: 800, fontSize: '0.9rem', color: '#ffffff', lineHeight: 1.2 }}>{rev.name}</div>
                        <div style={{ fontSize: '0.725rem', color: 'var(--text-muted)', lineHeight: 1.3 }}>{rev.role}</div>
                      </div>
                    </div>
            ...
            {reviews.map((_, idx) => (
              <button
                ...
                style={{
                  ...
                  height: '7px',
                  borderRadius: '9999px',
                  background: activeIndex === idx ? 'linear-gradient(90deg, #5B1AEA, #c084fc)' : 'rgba(255, 255, 255, 0.2)',
                  border: 'none',
                  cursor: 'pointer',
                  transition: 'all 0.3s ease',
                  boxShadow: activeIndex === idx ? '0 0 15px rgba(91, 26, 234, 0.6)' : 'none'
                }}
              />
            ))}
          </div>
